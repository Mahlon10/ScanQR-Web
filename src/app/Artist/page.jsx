...
import ThemeToggle from '@/components/Pages/Artist/Toggle';
import Cardscan from '@/components/Pages/Artist/Cardscan';
...
export default function HeroBanner() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url("https://i.postimg.cc/PJx80CwD/artist.jpg")',
      }}
    >
      {/* Left Heading */}
      ...
      <img
        src="https://i.postimg.cc/HnRrJHS8/Art.png"
        alt="Card Scan"
        onClick={openScan}
      ...
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-center text-white">
        <div className="font-bold text-xl">John Kenol</div>
        <div className="text-base">Music Producer || Podcaster</div>
      </div>

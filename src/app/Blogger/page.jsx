...
import ThemeToggle from '@/components/Pages/Blogger/Toggle';
import Cardscan from '@/components/Pages/Blogger/Cardscan';
...
export default function HeroBanner() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url("https://i.postimg.cc/KzQM9PRF/blogger4.jpg")',
      }}
    >
      {/* Left Heading */}
      ...
      <img
        src="https://i.postimg.cc/5yY0WTx4/blog.png"
        alt="Card Scan"
        onClick={openScan}
      ...
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-center text-white">
        <div className="font-bold text-xl">Kimi Dantey</div>
        <div className="text-base">Blogger || Journalist</div>
      </div>

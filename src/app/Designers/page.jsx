...
import ThemeToggle from '@/components/Pages/Designer/Toggle';
import Cardscan from '@/components/Pages/Designer/Cardscan';
...
export default function HeroBanner() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url("https://i.postimg.cc/nLbBMVy8/designer.jpg")',
      }}
    >
      {/* Left Heading */}
      ...
      <img
        src="https://i.postimg.cc/fbHDTsTc/des.png"
        alt="Card Scan"
        onClick={openScan}
      ...
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-center text-white">
        <div className="font-bold text-xl">Melvin Woode</div>

...
import ThemeToggle from '@/components/Pages/Developer/Toggle';
import Cardscan from '@/components/Pages/Developer/Cardscan';
...
export default function HeroBanner() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url("https://i.postimg.cc/WpWZgwBw/developer1.jpg")',
      }}
    >
      {/* Left Heading */}
      ...
      <img
        src="https://i.postimg.cc/nL2M4qRJ/dev.png"
        alt="Card Scan"
        onClick={openScan}
      ...
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-center text-white">
        <div className="font-bold text-xl">Lorenzo Neeson</div>

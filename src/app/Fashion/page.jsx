...
import ThemeToggle from '@/components/Pages/Fashion/Toggle';
import Cardscan from '@/components/Pages/Fashion/Cardscan';
...
export default function HeroBanner() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url("https://i.postimg.cc/9FsqNFF4/fashion.jpg")',
      }}
    >
      {/* Left Heading */}
      ...
      <img
        src="https://i.postimg.cc/5yht4g0w/fash.png"
        alt="Card Scan"
        onClick={openScan}
      ...
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-center text-white">
        <div className="font-bold text-xl">Mary Chan</div>
        <div className="text-base">Bevy Clothing</div>
      </div>
